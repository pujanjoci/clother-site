...
const BannerCarousel = () => {
  ...
  return (
    <div
  className="relative flex flex-col items-center justify-center w-full md:w-[1425px] h-96 overflow-hidden mx-auto"
  ref={carouselRef}
...
>
  ...
  <img
    ...
    className={`w-full md:w-[1540px] h-full object-cover ${isMobile ? '' : 'aspect-[16/9]'}`}
  />
